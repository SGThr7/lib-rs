...
mod tests {
    ...
    fn pow() {
        ...
        let ans = vec![
            ...
            vec![
                31644432, 38881944, 46119456, 71662158, 88052265, 104442372, 111679884, 137222586,
                162765288,
            ],
            vec![
                510008400, 626654232, 743300064, 1154967822, 1419124617, 1683281412, 1799927244,
                2211595002, 2623262760,
            ],
            vec![
                8219725776,
                10099688472,
